...
exports.PseudonymBases = exports.AttributeBoundPseudonym = exports.Pseudonym = void 0;
 ...
 */
class Pseudonym extends bytearray_wrapper_1.BytearrayWrapper {
    /**
     *
     ...
     */
    static new(base, secretKey) {
        return new Pseudonym((0, crypto_wasm_1.pedersenCommitmentG1)([base], [secretKey]));
    }
}
 ...
 */
class AttributeBoundPseudonym extends bytearray_wrapper_1.BytearrayWrapper {
    /**
     *
     ...
     * @param secretKey
     */
    static new(basesForAttributes, attributes, baseForSecretKey, secretKey) {
        ...
        return new AttributeBoundPseudonym((0, crypto_wasm_1.pedersenCommitmentG1)(b, m));
    }
}
exports.AttributeBoundPseudonym = AttributeBoundPseudonym;
/**
 * Used to create commitment key for pseudonyms
 */
class PseudonymBases {
    /**
     ...
     */
    static generateBaseForSecretKey(scope) {
        return (0, crypto_wasm_1.generateRandomG1Element)(scope);
    }
    /**
     ...
     */
    static generateBasesForAttributes(attributeCount, scope) {
        const b = [];
        let s;
        if (scope !== undefined) {
            s = Array.from(scope);
        ...
        for (let i = 0; i < attributeCount; i++) {
            s[s.length - 1] = i + 1;
            b.push((0, crypto_wasm_1.generateRandomG1Element)(new Uint8Array(s)));
        }
        return b;
    }
}
exports.PseudonymBases = PseudonymBases;
